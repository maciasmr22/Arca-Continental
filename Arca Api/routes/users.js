...
router.get('/insertEntrega/:subid/:supid/:puntaje', UsersControllers.insertEntrega)
router.get('/updateEntrega/:subid/:supid/:puntaje', UsersControllers.updateEntrega)
